...
function jptheme_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'jptheme' ),
		'social'  => __( 'Social Links Menu', 'jptheme' ),
	) );
...
/*Adding menu option*/
add_action( 'admin_menu', 'register_jptheme_menu_page' );

function register_jptheme_menu_page() {

	add_menu_page( 'JPTheme Options', 'JPTheme Options', 'manage_options', 'jptheme-admin', 'jptheme_admin_settings', 'dashicons-admin-generic', 100 );
}

function jptheme_admin_settings(){
	include('jptheme-admin.php');
}

add_action( 'admin_menu', 'register_jptheme_submenu_page_general' );

function register_jptheme_submenu_page_general() {

	add_submenu_page( 'jptheme-admin', 'General', 'General', 'manage_options', 'jptheme-general', 'jptheme_admin_general' );
}

function jptheme_admin_general(){
	include('jptheme-general.php');
}




// function jptheme_menu() {
// 	add_options_page( 'JPTheme Options', 'JPTheme', 'manage_options', 'jptheme_admin_menu', 'jptheme_options' );
// }

// add_action( 'admin_menu', 'jptheme_menu' );

// /** Step 3. */
// function jptheme_options() {
